...
// We recommend running this in landscape mode
// the buttons might be quite small on a typical android screen
// so you've got work to do to make it really usable on Android! 
// e.g. use different screens for different instruments, etc. 
// also the code is very monolithic and scripty - engineers
// will surely enjoy refactoring into a nice set of classes
