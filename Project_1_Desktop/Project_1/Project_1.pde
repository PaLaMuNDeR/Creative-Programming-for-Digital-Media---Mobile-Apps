...
//Purpose:
//This program interacts with the accelerometer
//of android device.
//It takes the data and represent it as colors 
//of the background and a bubble.
//It contains 6 different audio tracks of instruments
//by clicking on photos of the instruments you can make
//them play and with accelerometer to speed them up,
//slow down, volume up or down.
//Nice graphics are used as:
//the bubble is bouncing as the rythm (bass)
//the wave in the middle is going with the speed of music 
//and the frequency.
//Smoother the sound -  smoother the wave.
//
//Martin Anev 26.06.2013
